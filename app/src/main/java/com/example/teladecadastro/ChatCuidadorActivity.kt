...
class ChatCuidadorActivity : AppCompatActivity() {
    ...
    private val connectionId = "0Wt1DP8HT7gNWT3jKrqfSnbXVpt2-PyycJmBw57gtPHb3Wsbs3mCVUEv2"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Receber o connectionId da Intent
    ...
    private fun setupUI() {
        ...
        sendButton.setOnClickListener {
            Log.d("ChatCuidadorActivity", "Botão de enviar clicado")
            sendMessage()
        }
        btnBack.setOnClickListener { finish() }
        menuIcon.setOnClickListener { showPopupMenu(it) }
    ...
    private fun clearMessages() {
        ...
        // Remove as mensagens do Firebase
        messageRef.removeValue()
            .addOnSuccessListener {
                // Remove mensagens da lista local
                messageList.clear()
